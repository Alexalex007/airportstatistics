...
const AIRPORT_RAW_DATA: Record<string, {
  ...
  "MNL": {
    ...
    summaries: {
      2026: "2026年數據尚未發布。",
      2025: "2025年數據截至9月，累計客運量達 3,851 萬人次 (38,514,798)，較 2024 年同期成長約 3.8%。其中 1 月創下 471 萬人次高峰，顯示菲律賓航空市場需求持續熱絡。",
      2024: "2024年全年客運量達 4,939 萬人次 (49,392,381)，較 2023 年增長約 10.0%。單月客運量於 12 月達到 461 萬人次高峰。",
      2023: "2023年全年客運量為 4,488 萬人次 (44,888,450)。隨著旅遊限制解除，客運量穩步回升。"
    },
    stats: {
      2026: [],
...
export const fetchAirportStats = async (query: string, year: number = 2024): Promise<AirportData> => {
  ...
  if (!summary) {
    // Fallback logic
    if (year > 2025) summary = "數據待更新。"; // Extended for future years
